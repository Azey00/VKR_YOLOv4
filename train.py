        ...
        if rank in [-1, 0]:
            ...
            if save:
                ...
                if (epoch % 3 == 0) and (epoch != 0):
                    ...
                    save_folder = "C:/Users/vlad/Desktop/weigh/"
                    file_saved_parameters = prefix + "_YOLOv4-tiny_Params_16_batch_1024_size.pth"
                    torch.save(ckpt, os.path.join(save_folder, file_saved_parameters))
